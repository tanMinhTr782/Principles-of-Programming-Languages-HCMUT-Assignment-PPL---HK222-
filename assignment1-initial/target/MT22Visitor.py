...
class MT22Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MT22Parser#vardecl_list.
    def visitVardecl_list(self, ctx:MT22Parser.Vardecl_listContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MT22Parser#blockstmt_or_not.
    def visitBlockstmt_or_not(self, ctx:MT22Parser.Blockstmt_or_notContext):
        return self.visitChildren(ctx)
